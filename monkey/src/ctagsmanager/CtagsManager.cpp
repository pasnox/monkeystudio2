...
/*!
	...
	\brief Implementation for \link CtagsManager CtagsManager class \endlink
*/
...
*/
CtagsManager::CtagsManager (QObject* parent) :QObject (parent)
{
	initializeParsing ();
...
*/
bool CtagsManager::updateFileRecord (QString file) //reparse file if need, or parse first time
{
...
FileRecord* CtagsManager::GetTagsForFile (QString file )
{
...
//RecordsList* CtagsManager::GetTagsForAllFiles ()
//{
// 	checkForChanges ();
// 	return &records;
//}

//void CtagsManager::checkForChanges ()
//{
...
*/
void CtagsManager::freeTagEntryList (TagEntryListItem* item)
{
	while ( item != NULL )
	{
