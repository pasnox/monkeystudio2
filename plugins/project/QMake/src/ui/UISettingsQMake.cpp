...
QtVersionList UISettingsQMake::defaultVersions()
{
	...
	<< QtVersion( "Qt 4", "C:\\Qt\\4.3.2", "qmake.exe", "lupdate", "lrelease", "C:\\Qt\\4.3.2\\doc\\html", true )
	<< QtVersion( "Qt 3", "C:\\Qt\\3.3.7", "qmake.exe", "lupdate", "lrelease", "C:\\Qt\\3.3.7\\doc\\html", false );
#else
