...
/*!
 ...
 It gathers functions in three big families. Functions generated by the target (targetStopped, targetRunning, targetExited, 
 targetLoaded and targetNoLoaded) , functions generated by Gdb (gdbStarted, gdbFinished, gdbExited) and functions generated 
 by a command (error, info, done, prompt).
...
public:
	 ...
	 * 
	 * This is used for send the commmand to Gdb. It work with GdbParser
	 *
	 * \code
	 * Parser()->setNextCommand( name(), "command has to send"); 
	 * Process()->sendRawData("command has to send");
