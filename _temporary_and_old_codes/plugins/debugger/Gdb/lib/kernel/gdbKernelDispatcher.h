...
public :
	...
	void add( const QPointer< class GdbAddonBase> &);
	void clear();
	...
	QPointer< class GdbAddonBase> findAddon(const QString & name);
...
private :
	...
	*/
	QList<QPointer< class GdbAddonBase> > addonList;

	QHash<QString, QPointer< class GdbAddonBase > > mAddonList;
signals :
	void errorMessage(QString, int);
