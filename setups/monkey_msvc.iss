...
Source: bin\plugins\builder\GNUMake.dll; DestDir: {app}\plugins; Flags: promptifolder; Components: All_Plugins Plugins\Builder
Source: bin\plugins\builder\MSVCMake.dll; DestDir: {app}\plugins; Flags: promptifolder; Components: All_Plugins Plugins\Builder Qt_Plugins
...
Source: bin\plugins\compiler\G++.dll; DestDir: {app}\plugins; Flags: promptifolder; Components: All_Plugins Plugins\Compiler
Source: bin\plugins\compiler\GccParser.dll; DestDir: {app}\plugins; Flags: promptifolder; Components: All_Plugins Plugins\Compiler
Source: bin\plugins\compiler\Gcc.dll; DestDir: {app}\plugins; Flags: promptifolder; Components: All_Plugins Plugins\Compiler
Source: bin\plugins\compiler\MSVC.dll; DestDir: {app}\plugins; Flags: promptifolder; Components: All_Plugins Plugins\Compiler Qt_Plugins
