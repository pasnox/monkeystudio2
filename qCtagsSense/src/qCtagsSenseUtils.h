...
namespace qCtagsSenseUtils
{
	...
	QCTAGSSENSE_EXPORT qCtagsSenseEntry::Kind kindType( const QChar& c );
	QCTAGSSENSE_EXPORT qCtagsSenseEntry::Kind kindType( const QString& string );
	QCTAGSSENSE_EXPORT QChar kindChar( qCtagsSenseEntry::Kind kind );
	QCTAGSSENSE_EXPORT QString kindText( const QChar& c );
	
	QCTAGSSENSE_EXPORT qCtagsSenseEntry::Kind kindType( const QChar& c, const QString& language );
	QCTAGSSENSE_EXPORT QChar kindChar( qCtagsSenseEntry::Kind kind, const QString& language );
	QCTAGSSENSE_EXPORT QString kindText( qCtagsSenseEntry::Kind kind );
