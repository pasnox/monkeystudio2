...
def check_qscintilla():
    ...
    if os.access(sciglobal, os.F_OK):
        ...
        if glob.glob(os.path.join(opt_qscilibdir, "*qscintilla2*")):
            ...
            # versioning.
            if sciversstr != "2-snapshot-20071205":
                sipconfig.error("QScintilla %s is being used but the Python bindings 2-snapshot-20071205 are being built.  Please use matching versions." % sciversstr)
